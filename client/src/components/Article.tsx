...
const Article: React.FC<ArticleProps> = ({title, url, handleSimilar}) => {
          ...
          <div className='relative bg-stone-300 h-80'>
            {isLoading ? (
              ...
              <img
                ...
                src={"https://assets.awwwards.com/awards/media/cache/thumb_880_660/submissions/2023/09/650c1724dda03854684181.jpg"}
                alt='screenshot of the website'
              />
            )}
            </div>

            <div className='absolute inset-0 p-6 bg-gradient-to-t from-black/75 flex flex-col justify-between transition-opacity duration-300' 
                ...
                <div className='flex justify-between'>
                    <div className='flex gap-2'>
                        ...
                        <button className='px-4 py-2 bg-stone-100 rounded-full font-semibold' onClick={handleSimilar}>Preview</button>
                    </div>
